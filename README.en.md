<div align="center">
    <a href="https://pypi.python.org/pypi/ChatRead">
        <img src="https://img.shields.io/pypi/v/ChatRead.svg" alt="PyPI version" />
    </a>
    <a href="https://github.com/ChatArch/ChatRead/actions/workflows/ci.yml">
        <img src="https://github.com/ChatArch/ChatRead/actions/workflows/ci.yml/badge.svg" alt="Tests" />
    </a>
    <a href="https://arch.gh.wzhecnu.cn/ChatRead/">
...
- No domain configuration or empty ChatEnv provider is registered yet. Reuse ChatEnv typed profiles when actual configuration is needed; no API key is assumed.
